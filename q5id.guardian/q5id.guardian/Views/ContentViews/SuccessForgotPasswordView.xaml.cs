...
{
    public partial class SuccessForgotPasswordView : PopupPage
    {
        ...
        public static readonly BindableProperty OkCommandProperty =
            BindableProperty.Create(nameof(OkCommand), typeof(ICommand), typeof(SuccessForgotPasswordView), null);
        ...
        public SuccessForgotPasswordView()
        {
            InitializeComponent();
        }
